...
@interface AdSetQDCWebView : UIView
...
/**
 ...
 @param index 加载第几个广告
*/
- (void)loadWebViewWithAdSetQDCSpaceInfo:(AdSetQDCSpaceInfoModel *)spaceInfo index:(NSInteger)index;
- (void)loadWebViewWithAdSetQDCSpaceInfo:(AdSetQDCSpaceInfoModel *)spaceInfo index:(NSInteger)index isNative:(BOOL)isNative;
