...
/**
 圆形点击关闭按钮，适用于激励视频等广告
*/
@protocol AdSetQDCTimeCloseDelegate <NSObject>

@optional
/**
 圆形点击关闭按钮
 */
- (void)adsetqdc_dotCloseButton;

@end

@interface AdSetQDCDotCloseView : UIView

@property (nonatomic, weak) id<AdSetQDCTimeCloseDelegate> delegate;
