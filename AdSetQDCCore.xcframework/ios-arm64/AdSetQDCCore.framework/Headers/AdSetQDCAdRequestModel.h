//
//  AdSetQDCCoreSDKAdRequestModel.h
//  AdSetQDCCoreSDK
//
...
#import <AdSetQDCCore/AdSetQDCAdLocationModel.h>

NS_ASSUME_NONNULL_BEGIN

@class AdSetQDCGeoModel;
@class AdSetQDCDevInfoModel;
@class AdSetQDCEnvInfoModel;
@class AdSetQDCAdReqInfoModel;
@class AdSetQDCSdidModel;

/**
 广告请求的model
*/
@interface AdSetQDCAdRequestModel : AdSetQDCBaseModel
...
//  设备model
@property (nonatomic, strong) AdSetQDCDevInfoModel *devInfo;
//  用户信息
@property (nonatomic, strong) AdSetQDCEnvInfoModel *envInfo;
//  广告信息
@property (nonatomic, strong) NSMutableArray<AdSetQDCAdReqInfoModel *> *adReqInfo;
//  app版本
...
摇一摇相关参数配置
 */
@property (nonatomic, strong) AdSetQDCAdShakeConfigModel *shakeValue;
/**
定位相关参数配置
 */
@property (nonatomic, strong) AdSetQDCAdLocationModel *locInfo;
...
@interface AdSetQDCDevInfoModel : AdSetQDCBaseModel
...
//  wifi名称
@property (nonatomic, copy) NSString *wifi;//70:BB:E9:9E:CD:0F,AdSetQDC3-5G",
//  设备CPU
...
@interface AdSetQDCEnvInfoModel : AdSetQDCBaseModel
...
//  地理位置model
@property (nonatomic, strong) AdSetQDCGeoModel *geo;
//  电量
...
@interface AdSetQDCGeoModel : AdSetQDCBaseModel
...
@interface AdSetQDCAdReqInfoModel : AdSetQDCBaseModel
...
@interface AdSetQDCSdidModel : AdSetQDCBaseModel
//  id值
