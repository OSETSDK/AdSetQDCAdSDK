...
@interface AdSetQDCAdAES : NSObject

+ (NSString *)AdSetQDCAdAESEncrypt:(NSString *)originalStr
                      mode:(MIUMode)mode
                       key:(NSString *)key
...
+ (NSString *)AdSetQDCAdAESDecrypt:(NSString *)originalStr
                      mode:(MIUMode)mode
                       key:(NSString *)key
                   keySize:(MIUKeySizeAES)keySize
                        iv:(NSString * _Nullable )iv
...
+ (NSData *)AdSetQDCAdAESEncryptData2:(NSData *)originalData
                      mode:(MIUMode)mode
                       key:(NSString *)key
                   keySize:(MIUKeySizeAES)keySize
                        iv:(NSString * _Nullable )iv
...
+ (NSString *)AdSetQDCAdAESEncryptData:(NSData *)originalData
                      mode:(MIUMode)mode
                       key:(NSString *)key
                   keySize:(MIUKeySizeAES)keySize
                        iv:(NSString * _Nullable )iv
...
//+ (NSString *)AdSetQDCAdAESDecryptData:(NSData *)originalData
//                      mode:(MIUMode)mode
//                       key:(NSString *)key
//                   keySize:(MIUKeySizeAES)keySize
//                        iv:(NSString * _Nullable )iv
