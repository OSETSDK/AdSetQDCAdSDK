...
/**
 首页倒计时，可点击关闭按钮
*/
@protocol AdSetQDCCountDownCloseDelegate <NSObject>
...
@interface AdSetQDCCountDownView : UIView

@property (nonatomic, weak) id<AdSetQDCCountDownCloseDelegate> delegate;
